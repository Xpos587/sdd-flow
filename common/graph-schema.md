...
- implementation: String (path to the component file, e.g., "/src/frontend/components/properties-view.tsx", or if the implementation of the components does not takes the whole file - shared with other components - include the class/function name, e.g., "src/backend/db/models.py::Property")
...
- description: String
- transactions: List[str] (list of transaction IDs it participates in, e.g., ["T2.1", "T2.2", "T2.3", "T2.4", "T2.5", "T2.6"])
- implementation: String (path to file and function name - handler, e.g., "src/backend/domains/prop/property_service.py::create_property(), "src/frontend/domains/prop/use-properties.tsx::handlePropertyCreation()")
- status: String (e.g., "IMPLEMENTED", "NOT_IMPLEMENTED", "PLANNED")
...
- implementation: String (specific object, e.g., "src/backend/domains/prop/models.py::PropertyListRequestDTO")
